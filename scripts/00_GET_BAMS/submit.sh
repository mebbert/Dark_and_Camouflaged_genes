...
####################################################################
il100_B37_Dir="ADSP_sample_CRAMs/" #directory containing the 10 illumina100 sample bams downloaded from ADSP (aligned to b37/hg19 by default)
...
sbatch submitWithSingularity.slurm "ADSP_sample_CRAMs/A-CUHS-CU000208-BL-COL-56227BL1_vcpa1.0_GRU-IRB-PUB.cram"

#for bam in $il100_B37_Dir/*.cram
#do
