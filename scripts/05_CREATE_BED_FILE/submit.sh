...
###################################################
REF="../../../GRCh38_full_analysis_set_plus_decoy_hla.fa" # hg38 reference
ANNO="../../results/annotation/hg38/Homo_sapiens.GRCh38.93.annotation.bed" # hg38 gene annotation bed output from Step 4

ILL100_LOW_COV="../results/illuminaRL100/combined/hg38/IlluminaRL100.hg38.combined.dark.low_depth.bed" #Combined ill100 depth output from step 2
ILL100_LOW_MAPQ="../results/illuminaRL100/combined/hg38/IlluminaRL100.hg38.combined.dark.low_mapq.bed" #Combined ill100 mapq output from step 2
...
##Illumina RL100
sbatch submitWithSingularity.slurm $ILL100_LOW_COV $ILL100_LOW_MAPQ $REF $ANNO $ILL100_RESULT_DIR
